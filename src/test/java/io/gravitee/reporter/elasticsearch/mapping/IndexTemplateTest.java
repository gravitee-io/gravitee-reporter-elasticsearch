 ...
 * or policy is malformed. Runs without the OpenSearch container {@link IndexPreparerIntegrationTest} needs,
 * which proves the complementary half — that a cluster accepts the rendered body.
 */
